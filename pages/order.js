  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <div class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
        ...
        <h1 class="text-gray-900 text-3xl title-font font-medium mb-4">Order Id : #8977</h1>
        ...
        <div class="flex border-t border-gray-200 py-2">
          <span class="text-gray-500">Shirt</span>
          <span class="ml-auto text-gray-900">1</span>
          <span class="ml-auto text-gray-900">₹499</span>
        </div>
        <div class="flex border-t border-gray-200 py-2">
          <span class="text-gray-500">Watch</span>
          <span class="ml-auto text-gray-900">1</span>
          <span class="ml-auto text-gray-900">₹1200</span>
        </div>
        <div class="flex border-t border-b mb-6 border-gray-200 py-2">
          <span class="text-gray-500">Hoodi</span>
